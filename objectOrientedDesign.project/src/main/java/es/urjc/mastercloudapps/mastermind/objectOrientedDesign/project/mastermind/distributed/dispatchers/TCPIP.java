...
public class TCPIP extends es.urjc.mastercloudapps.mastermind.objectOrientedDesign.project.utils.TCPIP {

    public static TCPIP createClientSocket() {
        try {
            Socket socket = new Socket("localhost", es.urjc.mastercloudapps.mastermind.objectOrientedDesign.project.utils.TCPIP.getPORT());
    ...
    public static TCPIP createServerSocket() {
        try {
            ServerSocket serverSocket = new ServerSocket(es.urjc.mastercloudapps.mastermind.objectOrientedDesign.project.utils.TCPIP.getPORT());
